...
<div id="menu">
    ...
    <transition name="fade-out">
        <div v-show="this.$route.path==='/menu' || this.$route.path==='/'   ">
            <div class="nav">
                <div class="logo"></div>
...
<a class="gv" href="avascript:;" @click="adminLogin()">注册</a>

 -->
                <!-- <router-link to="/regist"><a href="javascript:;">去注册</a></router-link> -->
                <!-- 	</router-link> -->
            </div>
        </div>
    </transition>
...
.logo {
    ...
    height: 108px;
    margin-bottom: 20px;
    background: url('../assets/images/iot艺术字图标1.png') no-repeat;
