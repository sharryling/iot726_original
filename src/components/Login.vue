    ...
    <div class="login-box">
        ...
        <form>
            <div class="ipunt-wrap" v-show="admin">
                ...
                <input type="text" id="ID" placeholder="账号" v-model="userid">		</div>
                <div class="ipunt-wrap">
                    <label for="account" class="icon-user"></label>
                    <input type="text" id="account" placeholder="用户名" v-model="account">		</div>
                    <div class="ipunt-wrap">
                        <label for="password" class="icon-password"></label>
                        <input type="password" id="password" placeholder="密码" v-model="password">		</div>
                        <div class="button">
...
<script>
var login_address = "http://111.231.244.208:8081/login"
...
export default {
    ...
    methods: {
        ...
        Login() {
                ...
                $.ajax({
                    url: login_address, //+ '?username=' + this.account + '?password=' + this.password ,//'https://cloudapi.usr.cn/usrCloud/user/login',
                    type: 'post',
                    dataType: 'json',
